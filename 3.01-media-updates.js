(() => {
  ...
  if (hostModel && !document.querySelector(".v210-crystallised-study")) {
    ...
    study.innerHTML = `
      <img src="./assets/3.01/term3-finalpre-178.webp" alt="Two crystallised fibre frameworks suspended over salt samples" loading="lazy" decoding="async" />
  ...
  if (metabolicImage) {
    metabolicImage.src = "./assets/3.01/term3-finalpre-17.webp";
  ...
  document.documentElement.dataset.layoutVersion = "3.01-webp-media";
